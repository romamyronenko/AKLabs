...
%.o: %.S 
	$(CC) -x assembler-with-cpp  $(CFLAGS) -mcpu=$(CPU_CC) -mthumb -c -o $@  $^
...
kernel.bin:
	$(CC) -x assembler-with-cpp  $(CFLAGS) -mcpu=$(CPU_CC) -mthumb -c  kernel.S -o kernel.o
	$(CC) -x assembler-with-cpp  $(CFLAGS) -mcpu=$(CPU_CC) -mthumb -c  print.S -o print.o
